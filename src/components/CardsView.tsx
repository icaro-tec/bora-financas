...
export const CardsView: React.FC<{ onAddCard: () => void }> = ({ onAddCard }) => {
  ...
  return (
    <div className="p-6 pb-40">
      <div className="flex justify-between items-center mb-8">
        ...
        <button 
          onClick={onAddCard}
          className="w-10 h-10 bg-indigo-50 rounded-xl flex items-center justify-center border border-indigo-100 active:scale-90 transition-all"
        >
